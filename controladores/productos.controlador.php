<?php
	...
	class ControladorProductos{
		...
		static public function ctrMostrarProductos($item, $valor){
			...
			$resultado = ModeloProductos::mdlMostrarProductos($tabla, $item, $valor);
		...
		/*=============================================
			VALIDAR CATEGORIAS SI HAY PRODUCTOS
		=============================================*/
		static public function ctrValidarMostrarProductos($item, $valor){
				
			$tabla = "productos";

			$resultado = ModeloProductos::mdlValidarMostrarProductos($tabla, $item, $valor);

			$cantidad = substr($resultado["cantidad"],0);
		...
		static public function ctrEliminarProductos(){
			...
			if (isset($_GET["idProducto"])) {
				...
				/*--- Aqui se elimina la imagen que tenga teniendo en cuenta que no se puede elimar la imagen que esta por defecto ---*/
