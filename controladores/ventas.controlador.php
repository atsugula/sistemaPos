...
class ControladorVentas{
	...
	static public function ctrMostrarVentas($item, $valor){
		...
		$respuestas = ModeloVentas::mdlMostrarVentas($tabla, $item, $valor);
	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevoPrecioNeto"])){
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			if($cambioProducto){
				...
				$item1a_2 = "compras";
				$valor1a_2 = array_sum($totalProductosComprados_2) + $valor1a;
	...
	static public function ctrEliminarVenta(){
		...
		if(isset($_GET["idVenta"])){
			...
			$item1a = "compras";
			$valor1a = $traerCliente["compras"] - $traerCliente["compras"];
