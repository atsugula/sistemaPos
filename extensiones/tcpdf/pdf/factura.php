...
$bloque2 = <<<EOF
	...
	<table style="font-size:10px; padding:5px 10px;">
		...
		<tr>
			...
			<td style="border: 1px solid #666; background-color:white; width:390">
...
$respuestaProducto = ControladorProductos::ctrMostrarProductosFactura($itemProducto, $valorProducto, $orden);

$valorUnitario = number_format($respuestaProducto["precio_venta"], 0);

$precioTotal = number_format($value["total"], 0);
