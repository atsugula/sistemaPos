...
class ModeloProductos{
	...
	static public function mdlValidarMostrarProductos($tabla, $item, $valor){

		if($item != null){

			$stmt = Conexion::conectar()->prepare("SELECT COUNT(descripcion) AS cantidad FROM $tabla WHERE $item = :$item");
